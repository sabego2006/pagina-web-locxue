 ...
 * Lógica interactiva aislada e independiente
 * ==========================================================================
 */
...
(function () {
  ...
  function initCategoryFilters() {
    ...
    filterBtns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        // Filtrar tarjetas con transición
  ...
  /**
   * 2. Animación de Contadores al hacer Scroll
   */
  ...
  /**
   * 3. Modal de Evidencias Fotográficas
   */
        ...
        if (modalFiles) {
          ...
          files.forEach(function (file) {
            if (file) {
              ...
              li.innerHTML = 
                '<div style="width: 100%;">' +
                  '<img src="imagenes/' + file + '" alt="' + file + '" style="max-width: 100%; height: auto; border-radius: 8px; margin-bottom: 0.5rem; display: block;" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'flex\';">' +
